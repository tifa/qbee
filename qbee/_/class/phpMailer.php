...
if (version_compare(PHP_VERSION, '5.0.0', '<')) {
	reportError(148, 'This version of phpMailer will only run on PHP version 5 or greater!');
	exit;
}
...
class phpMailer {
	...
	*/
	 ...
	 * @var string
	*/
	public $Hostname          = getenv('HOSTNAME');
	...
	*/
	public function DKIM_Add($headers_line, $subject, $body)
	{
		...
		$dkimhdrs .= "\tt=" . $DKIMtime . "; c=" . $DKIMcanonicalization . ";\r\n";
		$dkimhdrs .= "\th=From:To:Subject;\r\n";
		$dkimhdrs .= "\td=" . $this->DKIM_domain . ";" . $ident . "\r\n";
		$dkimhdrs .= "\tz=$from\r\n";
		$dkimhdrs .= "\t|$to\r\n";
		$dkimhdrs .= "\t|$subject;\r\n";
		$dkimhdrs .= "\tbh=" . $DKIMb64 . ";\r\n";
